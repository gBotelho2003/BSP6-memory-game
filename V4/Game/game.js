...
let stats = JSON.parse(localStorage.getItem("stats")) || {
    level1: { player: "", points: "", time: "", currLevel: "" , hints:""},
    level2: { player: "", points: "", time: "", currLevel: "" , hints:""},
    level3: { player: "", points: "", time: "", currLevel: "" , hints:""}
};
...
function openStatsAsCSV() {
    ...
    const rows = [
        ["Level", "Player Name", "Points", "Time", "Hints Used"],
        ["Level 1", stats.level1.player, stats.level1.points, stats.level1.time, stats.level1.hints],
        ["Level 2", stats.level2.player, stats.level2.points, stats.level2.time, stats.level2.hints],
        ["Level 3", stats.level3.player, stats.level3.points, stats.level3.time, stats.level3.hints]
    ];
